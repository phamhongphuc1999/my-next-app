...
export function SearchIcon(props: AppSvgProps) {
  return (
...
export function XIcon(props: AppSvgProps) {
  return (
    <svg {...props} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export function ChevronsUpDownIcon(props: AppSvgProps) {
  return (
    <svg {...props} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export function ChevronDownIcon(props: AppSvgProps) {
  return (
    <svg {...props} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export function CopyIcon(props: AppSvgProps) {
  return (
    <svg {...props} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      <path
        strokeLinecap="round"
