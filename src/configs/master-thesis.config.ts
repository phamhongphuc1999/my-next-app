import { ThesisCiteType } from 'src/global';

export const MasterReferences: Array<ThesisCiteType> = [
  {
    id: 'haber1991',
  ...
  {
    id: 'a-survey-of-blockchain',
    author: 'Ahmed Afif Monrat, Olov Schelén, Karl Andersson',
    title:
      'A Survey of Blockchain From the Perspectives of Applications, Challenges, and Opportunities',
    journal: 'IEEE Access',
    year: 2019,
    DOI: 'https://doi.org/10.1109/ACCESS.2019.2936094',
  },
  {
    id: 'merkle-tree',
    author:
