...
export default function FluxArchitecturePage() {
  return (
    <div className="mt-4">
      <img src="images/flux-architecture/flux-pattern.png" alt="flex-pattern" />
      <AppArticle isFirst>
      ...
      <Collapsible className="mt-4">
        <CollapsibleTrigger className="text-[20px] font-medium underline">
          Stores
        </CollapsibleTrigger>
        <CollapsibleContent>
      ...
      <Collapsible className="mt-4">
        <CollapsibleTrigger className="text-[20px] font-medium underline">View</CollapsibleTrigger>
        <CollapsibleContent>
          ...
          <span className="font-medium italic">Presentation</span> and{' '}
          <span className="font-medium italic">Container Views</span>.
      ...
      <Collapsible className="mt-4" open={true}>
        <CollapsibleTrigger className="text-[20px] font-medium underline">
          Read state
        </CollapsibleTrigger>
        <CollapsibleContent>
          <img src="images/flux-architecture/store-reads.png" alt="read" />
        </CollapsibleContent>
      </Collapsible>
      <Collapsible className="mt-4" open={true}>
        <CollapsibleTrigger className="text-[20px] font-medium underline">
        ...
        <CollapsibleContent>
          <img src="images/flux-architecture/sync-store-write.png" alt="read" />
        </CollapsibleContent>
      </Collapsible>
      <Collapsible className="mt-4" open={true}>
        <CollapsibleTrigger className="text-[20px] font-medium underline">
        ...
        <CollapsibleContent>
          <img src="images/flux-architecture/async-store-write.png" alt="read" />
        </CollapsibleContent>
      </Collapsible>
    </div>
  );
